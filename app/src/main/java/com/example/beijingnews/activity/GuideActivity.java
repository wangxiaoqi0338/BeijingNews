...
public class GuideActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //根据View的生命期，当n视图执行到layout或者onDraw的时候，视图的高和宽，边距都有了
    ...
    class MyOnPageChangeListener implements ViewPager.OnPageChangeListener{
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
           ...
           // int leftmargin = (int) (positionOffset * leftmax);
            //两点间滑动距离对应的坐标 = 原来的起始位置 + 两点间的移动距离
            int leftmargin =(int) (position *leftmax) + (int) (positionOffset * leftmax);
    ...
    class MyPagerAdapter extends PagerAdapter {
        ...
        /**
         * 作用,getView 将给定位置的view添加到ViewGroup（容器）中，创建并显示出来
         * @param container ViewPager
         * @param position
         * @return 返回和创建当前页面有关系的值（把创建页面返回）
         */
        @Override
